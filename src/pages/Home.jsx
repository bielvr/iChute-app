    ...
    <div className="min-h-screen bg-[#0A0E2A] text-white p-6">
      ...
      <div className="grid gap-4 max-w-lg mx-auto">
        {ESPORTES.map((esporte) => (
          <Link 
            key={esporte.id}
            // Certifique-se que sua rota no App.js aceita :sportId
            to={`/ligas/${esporte.id}`} 
          ...
          >
            {/* Aqui estava o erro: era 'sports.name' ou mudar o map para 'esporte' */}
            <span className="text-2xl font-black italic uppercase group-hover:text-[#0077FF] transition-colors">
              {esporte.name}
            </span>
